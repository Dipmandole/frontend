        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            {[
              ...
              <li key={link.label}>
                <a href={link.href} className="text-primary-foreground/50 hover:text-[#7c3aed] transition-colors flex items-center gap-1 group">
                  {link.label}
                  <ArrowUpRight className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" />
                </a>
              </li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-primary-foreground/50">
            {[
              ...
              <li key={s.label}>
                <Link to={s.href} className="hover:text-[#7c3aed] transition-colors flex items-center gap-1 group w-max">
                  {s.label}
                  <ArrowUpRight className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" />
                </Link>
              </li>
