        ...
        <nav className="hidden lg:flex items-center gap-0.5">
          {navLinks.map((link) => (
            <a
              ...
              className={`px-3.5 py-2 rounded-lg text-[13.5px] font-medium transition-all duration-200 ${
                isLight
                  ? "text-[#d1d5db] hover:text-[#7c3aed] hover:bg-[#7c3aed]/10"
                  : "text-white/90 hover:text-white hover:bg-white/15 drop-shadow-sm"
              }`}
            >
              {link.label}
        ...
        <div className="hidden lg:flex items-center gap-3 flex-shrink-0">
          ...
          >
            <div className={`w-7 h-7 rounded-lg flex items-center justify-center ${
              isLight ? "bg-[#7c3aed]/10" : "bg-white/20"
            }`}>
              <Phone className="w-3.5 h-3.5" />
            </div>
            +91 98765 43210
        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -8 }}
              transition={{ duration: 0.22, ease: "easeOut" }}
              className="lg:hidden relative z-50 bg-[#0b1f3a] border-b border-[#1f2937] shadow-xl"
            >
              <nav className="flex flex-col px-4 pt-3 pb-5 gap-0.5">
                {navLinks.map((link) => (
                  <a
                    ...
                    href={link.href}
                    onClick={() => setMobileOpen(false)}
                    className="px-4 py-3 rounded-xl text-[14px] font-medium text-[#d1d5db] hover:text-[#7c3aed] hover:bg-[#7c3aed]/10 transition-colors"
                  >
                    {link.label}
                  </a>
                ))}
                ...
                <div className="my-2 h-px bg-[#1f2937]" />

                <a
                  href="tel:+919876543210"
                  className="flex items-center gap-3 px-4 py-3 rounded-xl text-[14px] font-semibold text-[#d1d5db] hover:bg-[#1f2937]"
                >
