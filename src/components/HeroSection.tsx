...
const TimePicker = ({ value, onChange }: TimePickerProps) => {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        className="w-72 p-0 z-[200] border border-[#1f2937] shadow-2xl rounded-2xl overflow-hidden"
      ...
      >
        ...
        <div className="px-4 pt-4 pb-3 border-b border-white/10">
          <p className="text-[#d1d5db] text-[10px] font-bold uppercase tracking-widest mb-1">
            Pickup Time
          </p>
        ...
        <div className="p-4 space-y-4">
          {/* Hours 1–12 */}
          <div>
            <p className="text-[#d1d5db]/40 text-[10px] font-bold uppercase tracking-widest mb-2">Hour</p>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    hour === h
                      ...
                      : "bg-[#111827] text-[#d1d5db] hover:bg-[#7c3aed]/20 hover:text-white"
                  )}
                >
                  {h.padStart(2, "0")}
                </button>
          ...
          {/* AM / PM */}
          <div>
            <p className="text-[#d1d5db]/40 text-[10px] font-bold uppercase tracking-widest mb-2">Period</p>
  ...
  return (
    <section className="relative min-h-[720px] md:min-h-screen flex items-center overflow-hidden" id="home">
      ...
      <div className="absolute inset-0">
        ...
        />
        {/* Bottom vignette */}
        <div className="hidden md:block absolute inset-0 bg-gradient-to-t from-[rgba(11,31,58,0.40)] via-transparent to-transparent" />
      ...
      {/* Glows */}
      <div className="absolute top-20 right-10 w-72 h-72 bg-sky-400/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-orange-400/20 rounded-full blur-[140px] pointer-events-none" />
            ...
            /*"rounded-3xl p-6 md:p-8
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-[#d1d5db] text-xs">Get an instant quote — no commitment</p>
                </div>
              </div>
              ...
              <AnimatePresence mode="wait">
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <p className="text-[#d1d5db] text-sm mb-3">We'll contact you within 30 minutes to confirm.</p>
                    <p className="text-xs font-mono bg-white/10 border border-white/10 px-3 py-1.5 rounded-lg inline-block text-[#d1d5db]">
                      ID: {bookingId}
                    </p>
                  ...
                  <motion.div key="form" className="space-y-2.5">
                          ...
                          <PopoverTrigger asChild>
                            <button
                              ...
                              className={cn(
                                ...
                                form.pickup_date ? "text-white" : "text-[#d1d5db]"
                              )}
                            >
                              <span>
                                {form.pickup_date
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                      <Select value={form.service_type} onValueChange={(v) => handleSelect("service_type", v)}>
                        <SelectTrigger className="h-11 rounded-xl text-sm bg-[#111827] border-[#1f2937] text-white data-[placeholder]:text-[#d1d5db]">
                    ...
                    <p className="text-center text-[11px] text-[#d1d5db] flex flex-wrap justify-center gap-x-3">
...
"
            ...
            >
              {stats.map((s) => (
                <div key={s.label}>
                  <p className="font-display font-bold text-2xl text-accent drop-shadow-sm">{s.value}</p>
                  <p className="text-[#d1d5db] font-medium text-sm mt-0.5">{s.label}</p>
                </div>
              ))}
            </motion.div>
          </motion.div>
