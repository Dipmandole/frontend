...
const Vehicles = () => (
  <section className="relative py-20 md:py-28 overflow-hidden" id="vehicles">
    ...
    {/* Decorative glows */}
    <div className="absolute top-10 left-1/4 w-96 h-96 bg-[#7c3aed]/8 rounded-full blur-[120px] pointer-events-none" />
    <div className="absolute bottom-10 right-1/4 w-80 h-80 bg-[#9333ea]/8 rounded-full blur-[100px] pointer-events-none" />
